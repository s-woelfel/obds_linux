...
featureCounts -p --countReadPairs -s 2  -T 8  -t exon -g gene_id -a /project/kenn0344/1_linux/2_rnaseq/2_genome/Mus_musculus.GRCm38.102.gtf.gz -o counts.txt /project/kenn0344/1_linux/2_rnaseq/3_analysis/aln-pe_sorted.bam
