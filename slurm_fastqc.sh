...
#SBATCH --outpu=ooutput.out
#SBATCH --error=errorx.err
...
fastqc  --nogroup --threads 2 --extract -o /project/kenn0344/1_linux/2_rnaseq/3_analysis/1_fastqc/  /project/kenn0344/1_linux/2_rnaseq/1_fastq/cd4_rep3_read1.fastq.gz /project/kenn0344/1_linux/2_rnaseq/1_fastq/cd4_rep3_read2.fastq.gz
