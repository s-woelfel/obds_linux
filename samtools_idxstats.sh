...
samtools idxstats -@ 8 /project/kenn0344/1_linux//2_rnaseq/3_analysis/aln-pe_sorted.bam > /project/kenn0344/1_linux//2_rnaseq/3_analysis/aln-pe_sorted.idxstats
