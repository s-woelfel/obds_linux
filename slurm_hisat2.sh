...
#SBATCH --output=read_mapping.out
#SBATCH --error=read_mapping.err
...
hisat2 --threads 8 -x /project/shared/linux/5_rnaseq/hisat2_index/mm10 \
-1 /project/kenn0344/1_linux/2_rnaseq/1_fastq/cd4_rep3_read1.fastq.gz \
-2 /project/kenn0344/1_linux/2_rnaseq/1_fastq/cd4_rep3_read2.fastq.gz \
--rna-strandness RF \
